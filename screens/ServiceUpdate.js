...
const ServiceUpdate = ({ route, navigation }) => {
    ...
    return (
        <View style={{ padding: 10 }}>
            ...
            <Button style={{margin: 20}} buttonColor="#ff555b" textColor="black" mode="contained" onPress={handleUploadImage}>Change Image</Button>
            ...
            />
            <Button buttonColor="#ff555b" textColor="black" mode="contained" onPress={handleUpdateService}>Update</Button>
        </View>
    );
}
